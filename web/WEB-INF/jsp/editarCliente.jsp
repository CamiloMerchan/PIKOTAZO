    ...
    <body>
        ...
        <div class="card-body">
            <form action="#" method="post" id="frm-registro">
				...
				<p class="Telefono">
					<textarea class="input" id="Telefono" placeholder="Telefono" name="Telefono"  value="${lista[0].Telefono}" onblur="revisar(this); revisaLongitud(this, 30)" onkeyup="revisar(this); revisaLongitud(this, 30)" autocomplete="off" required></textarea>
				</p>
